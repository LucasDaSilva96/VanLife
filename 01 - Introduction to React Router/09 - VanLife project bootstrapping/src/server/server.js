...
createServer({
  ...
  routes() {
    this.namespace = "api";
    (this.loading = false), (this.timing = 1000);
...
await setDoc(doc(vansRef, "Modest Explorer"), {
  id: "1",
  name: "Modest Explorer",
  price: 60,
  description:
...
await setDoc(doc(vansRef, "Beach Bum"), {
  id: "2",
  name: "Beach Bum",
  price: 80,
  description:
...
await setDoc(doc(vansRef, "Reliable Red"), {
  id: "3",
  name: "Reliable Red",
  price: 100,
  description:
...
await setDoc(doc(vansRef, "Dreamfinder"), {
  id: "4",
  name: "Dreamfinder",
  price: 65,
  description:
...
await setDoc(doc(vansRef, "The Cruiser"), {
  id: "5",
  name: "The Cruiser",
  price: 120,
  description:
...
await setDoc(doc(vansRef, "Green Wonder"), {
  id: "6",
  name: "Green Wonder",
  price: 70,
  description:
...
await setDoc(doc(usersRef, "Test user"), {
  id: "123",
  email: "example@test.com",
  password: "test123",
  name: "Test User",
